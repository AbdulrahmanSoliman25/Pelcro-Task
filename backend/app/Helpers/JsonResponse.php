...
class JsonResponse
{
    ...
    const MSG_MIS_PASS = "responses.msg_mismatch_password";
    const MSG_Login_Success = "responses.msg_login_success";
    const MSG_Logout_Success = "responses.msg_logout_success";
